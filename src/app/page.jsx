...
export default function Page() {
  return (
    <>
      <section className='p-4 h-[680px] lg:h-screen flex flex-col-reverse lg:flex-row justify-center lg:justify-evenly items-center gap-4 bg-yellow-200' id="hero">
        ...
        <div className='flex flex-col'>
          <img className='w-full md:max-w-[680px] rounded-tl-full rounded-br-3xl' src="https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="image" />
        </div>
      </section>
      <section className='flex py-6 gap-3 justify-around' id="featured">
        <div className='flex flex-col gap-3'>
          <img className='max-w-[280px] aspect-square object-fill' src="/homepage/1.png" alt="image" />
          <h4 className='text-2xl font-medium'>Side Table</h4>
          <Link className='link underline-offset-8' href={"#"}>View More</Link>
        </div>
        <div className='flex flex-col gap-3'>
          <img className='max-w-[280px] aspect-square object-fill' src="/homepage/2.png" alt="image" />
          <h4 className='text-2xl font-medium'>Side Table</h4>
          <Link className='link underline-offset-8' href={"#"}>View More</Link>
        </div>
      </section>
      ...
      <ContentWrapper id="top-picks">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 justify-around'>
          ...
          <div className='flex flex-col items-start gap-2'>
            <img className='block w-[280px] aspect-square object-contain' src="/homepage/3.png" alt="sofa image" />
            <h6>Trenton Modular Sofa 3</h6>
            <h4 className='text-xl font-semibold'>Rs. 25,000.00</h4>
          </div>
          {/* Top picks Item 2 */}
          <div className='flex flex-col items-start gap-2'>
            <img className='block w-[280px] aspect-square object-contain' src="/homepage/4.png" alt="sofa image" />
            <h6>Trenton Modular Sofa 3</h6>
            <h4 className='text-xl font-semibold'>Rs. 25,000.00</h4>
          </div>
          {/* Top picks Item 3 */}
          <div className='flex flex-col items-start gap-2'>
            <img className='block w-[280px] aspect-square object-contain' src="/homepage/5.png" alt="sofa image" />
            <h6>Trenton Modular Sofa 3</h6>
            <h4 className='text-xl font-semibold'>Rs. 25,000.00</h4>
          </div>
          {/* Top picks Item 4 */}
          <div className='flex flex-col items-start gap-2'>
            <img className='block w-[280px] aspect-square object-contain' src="/homepage/6.png" alt="sofa image" />
            <h6>Trenton Modular Sofa 3</h6>
            <h4 className='text-xl font-semibold'>Rs. 25,000.00</h4>
          </div>
        </div>
